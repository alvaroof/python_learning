...
class IMAPCheckerTests(unittest.TestCase):
    ...
    def test_get_message_uids(self):
        ...
        self.assertEqual(
            uids,
            (
                imap_mock.return_value.uid.return_value.__getitem__.return_value.__getitem__.return_value.split.return_value
            ),
        )
    ...
    def test_get_message(self):
        ...
        self.assertEqual(imap_mock.mock_calls, [call(host), call().uid("fetch", uid, "(RFC822)")])
        self.assertEqual(
            parser_mock.mock_calls,
            [
                call(),
